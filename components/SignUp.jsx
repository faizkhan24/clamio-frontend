...
const SignUp = () => {
  ...
  return (
    <div className="grid h-screen w-screen place-items-center bg-secondary overflow-hidden">
      <div className="h-autp w-11/12 sm:w-3/4 md:h-auto md:w-1/2 lg:w-1/3 xl:w-1/4 rounded-lg bg-white p-5">
        <h1 className="text-center text-xl font-bold">Create Your Account</h1>
        <div className="mx-6 grid place-items-center">
          <label className="text-md w-full py-2 font-semibold">Username*</label>
          <input
            type="text"
          ...
          <p className=" mx-1 justify-self-end text-xs text-gray-400 ">
            By tapping 'Register' you are agreeing to the <span className="underline cursor-pointer">Terms of Service</span> and <span className="underline cursor-pointer">Privacy Policy</span>
          </p>
